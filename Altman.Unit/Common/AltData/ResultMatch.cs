    ...
    public class ResultMatch
    {
        ...
        public static OsDisk MatchResultToOsDisk(byte[] resultBytes, Encoding encode)
        {
            ...
            else
            {
                ...
                {
                    ShellDir = m.Groups["ShellDir"].Value,
                    AvailableDisk = m.Groups["AvailableDisk"].Value
                };
                return disk;
            }
        }
        public static OsInfo MatchResultToOsInfo(byte[] resultBytes, Encoding encode)
        {
            ...
            else
            {
                OsInfo info = new OsInfo
                {
                    ...
                    CurrentUser = m.Groups["CurrentUser"].Value,
                    DirSeparators = m.Groups["DirSeparators"].Value
                };
                return info;
            }
        }
