...
namespace Plugin_FileManager
{
    public class FileUploadOrDownload
    {
        ...
        public FileUploadOrDownload(Shell shellData, string sourceFilePath, string targetFilePath)
        {
        ...
        {
            ShowMsgInStatusBar("Downloading...", true);
        ...
        {
            ShowMsgInStatusBar("Uploading...", true);
